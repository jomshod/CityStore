...
//            .setDatabaseUrl("https://your-second-database-url.firebaseio.com")
    ...
    private fun fetchItemsFromFireStore() {
        ...
        db.collection("items")
            ...
            .addOnSuccessListener { result ->
                ...
                allItems = itemList
                _homeUiState.value = _homeUiState.value.copy(homeItems = allItems)
    ...
    private fun fetchProductsFromSecondFireStore() {
        ...
        secondDb.collection("products")
            ...
            .addOnSuccessListener { result ->
                ...
                _homeUiState.value = _homeUiState.value.copy(products = allProducts)
    ...
    fun onSubCategorySelected(subCategory: SubCategory) {
        ...
        val filteredItems = allItems.filter {
            it.category == _homeUiState.value.selectedCategory?.name &&
    ...
    fun updateItem(item: Item){
        _homeUiState.value= _homeUiState.value.copy(item=item)
    }
