    ...
    Scaffold(
        ...
        Column(modifier = modifier.padding(paddingValues)) {
            ...
            CategoryRow(
                ...
                onAllClick = { vm.onAllClick() }, selectedCategory = homeUiState.selectedCategory
            )

            // Show subcategories if a category is selected
            if (homeUiState.isCategorySelected) {
                SubCategoryRow(
                    subCategories = homeUiState.subCategories,
                    selectedSubCategory = homeUiState.selectedSubCategory,
