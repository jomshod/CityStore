...
import com.jimmy.citystore.elctronics.ElectronicsStoreScreen
import com.jimmy.citystore.gents.GentsStoreScreen
import com.jimmy.citystore.kids.KidsStoreScreen
import com.jimmy.citystore.ladies.LadiesStoreScreen
...
fun AppNavigation() {
    ...
    NavHost(navController = navController, startDestination = AppScreens.Splash.route) {
        ...
        composable(AppScreens.KidsStore.route){ KidsStoreScreen() }
